        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in animation-delay-100">
                Crafting <span className="text-primary glow-text">meaningful</span> digital experiences with creativity and precision.
              </h1>
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in animation-delay-300">
              ...
              <a href="/HPx_resume.pdf" download>
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                ...
                <a
                  ...
                  className="p-2 rounded-full glass hover:bg-primary/10 hover:text-primary transition-transform duration-300 hover:scale-110"
                >
          ...
          <div className="relative animate-fade-in animation-delay-300">
            <div className="relative max-w-md mx-auto">
              <div className="absolute inset-0 rounded-3xl from-primary/30 via-transparent to-primary/10 blur-xl animate-pulse" />
